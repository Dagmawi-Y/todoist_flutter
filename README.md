<div align="center">
      <h1> <img src="https://w7.pngwing.com/pngs/289/185/png-transparent-hook-check-mark-check-completed-finish-to-do-todo-list-check-off-district-thumbnail.png" width="80px"><br/>todoist_flutter</h1>
     </div>
<p align="center"> <a href="dagmawi.dev" target="_blank"><img alt="" src="https://img.shields.io/badge/Website-EA4C89?style=normal&logo=dribbble&logoColor=white" style="vertical-align:center" /></a> <a href="}" target="_blank"><img alt="" src="https://img.shields.io/badge/LinkedIn-0077B5?style=normal&logo=linkedin&logoColor=white" style="vertical-align:center" /></a> </p>

# Description
A todo app built with flutter/ dart

# Features
Modern and beautiful flutter app to manage tasks and focus on the most important things in life.
